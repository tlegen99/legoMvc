...
(34, 41, '902299b6d1af42a1adde6fc185c5fb06.jpg'),
...
(4, 0, 1, 'Bentley Arnage R 6.8', 'В сентябре 2006 года дебютировали обнавленные модели Arnage в исполнениях T,R и RL. Изменения коснулись как экстерьера автомобиля, так и интерьера, была модернизирована и конструкция. Внешне обновленные Arnage отличает новая радиаторная решетка, носовая скульптура с фирменной “крылатой B” для версий R и RL, эмблемы Bentley на подшипниках для колесных дисков, новая ксеноновая светотехника и эмблемы на задних стойках крыши. Версии Arnage R и Arnage RL предлагаются с салоном, отделанным корнем орехового дерева и кожей и двухцветной окраской кузова.', 'd0bcec1ff8f2e625a25e49bb1726bc16.jpg'),
