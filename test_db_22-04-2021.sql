...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 22 2021 г., 20:55
...
INSERT INTO `users` (`id`, `first_name`, `nick_name`, `email`, `access_level`, `pass_hash`, `avatar`) VALUES
(1, 'Админ', 'admin', 'aychanov.tlegen@mail.ru', 1, '25d55ad283aa400af464c76d713c07ad', NULL),
(2, 'Менеджер', 'manager', 'manager@mail.ru', 2, '25d55ad283aa400af464c76d713c07ad', NULL);
